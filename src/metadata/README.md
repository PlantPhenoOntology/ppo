 ...
 * [ppo.yml](ppo.yml)
     * Determines how your purl.obolibrary.org/obo/ppo/ redirects will be handled
     ...
     * Paste in the contents of [ppo.yml](ppo.yml)
 ...
 * [ppo.md](ppo.md)
     ...
     * Paste in the contents of [ppo.md](ppo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
