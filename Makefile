...
# not full paths.
termsfiles := PPO_supporting_classes.csv PPO_trait_properties.ods PPO_trait_classes.ods PPO_trait_convenience_classes.ods PPO_non-reproductive_stages.csv PPO_reproductive_stages.ods
