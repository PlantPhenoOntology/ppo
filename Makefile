...
# not full paths.
termsfiles := PPO_supporting_classes.ods PPO_properties.ods PPO_non-reproductive_stages.ods PPO_reproductive_stages.ods PPO_trait_classes.ods PPO_trait_convenience_classes.ods PPO_linker_classes.ods
