# Contributing to Plant Phenology Ontology

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to PPO. 
...
The Plant Phenology Ontology team strives to create a
...
Please use our [Issue Tracker](https://github.com/PlantPhenoOntology/ppo-odk/issues/) for reporting problems with the ontology. 
...
either as a primary term or a synonym term. You can search for your term using [OLS](http://www.ebi.ac.uk/ols/ontologies/ppo).
...
Request a new term _via_ the GitHub [Issue Tracker](https://github.com/PlantPhenoOntology/ppo-odk/issues/).

It is important to remember that it takes a lot of time for curators to process issues submitted to the tracker.
To make this work easier, please always use issue templates if they are available (https://github.com/PlantPhenoOntology/ppo-odk/issues/new/choose).
...
PPO is built complete using templates. Therefore, to make a pull request to this ontology, you must understand the specific editing workflow.


**Process**:

1. Create an issue specific to your edit
1. Clone the repository (In case you are not an offical team member, create a fork first)
1. Create new branch in git, using the "Create a branch" link on right side of the issue page, under development
1. **TODO:** Add documentation on how to edit PPO using templates so people can make pull requests
